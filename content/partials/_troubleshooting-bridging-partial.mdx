...
The variability of the dispute window comes from the slight variance of block times. Arbitrum One's dispute window is <Var name="arbOneDisputeWindowBlocks" /> blocks; this converts to about <Var name="arbOneDisputeWindowDays" /> days, assuming slightly more than 12 seconds per block, the average block time of Ethereum.
