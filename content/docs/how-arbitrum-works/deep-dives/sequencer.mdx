...
- [Finality](#finality): A summary of the soft and <Term id="hard-finality">hard finality</Term> levels, with a pointer to the full [Finality](/docs/how-arbitrum-works/deep-dives/finality) page (not a Sequencer task).
