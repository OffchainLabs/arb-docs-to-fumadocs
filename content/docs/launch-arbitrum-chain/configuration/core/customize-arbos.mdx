...
1. When you want to make changes to your Nitro code that affect the State Transition Function, or STF (you may refer to the [Customize STF docs](/docs/how-arbitrum-works/deep-dives/stf#introduction)), and
...
After you add a new precompile named `ArbHi` according to the guide in [customize precompile Option 2](./precompiles.mdx#option-2-create-a-new-precompile) and make changes to [`precompile.go`](https://github.com/OffchainLabs/<Var name="nitroRepositorySlug" />/blob/<Var name="nitroVersionTag" />/<Var name="nitroPathToPrecompiles" />/precompile.go),
...
Please continue reading [Customize STF](/docs/how-arbitrum-works/deep-dives/stf#step-3-run-the-node) for follow-up operations.
